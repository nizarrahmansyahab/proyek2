  ...
  <body class="" id="body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="d-flex my-2 justify-content-between">
                      ...
                      <p><a class="text-blue" href="">Lupa Password?</a></p>
                    </div>
                    <button type="submit" class="btn btn-lg btn-dark btn-block mb-4">Masuk</button>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2020 Copyright by
          <a class="text-primary" href="{{url('beranda')}}" target="_blank">Shopei</a>.
        </p>
      </div>
    </div>
